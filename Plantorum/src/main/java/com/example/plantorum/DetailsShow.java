...
public class DetailsShow {
    ...
    public void initialize(Document query) {
        ...
        String careinfos = String.join("\n ", "Light: " + light,"Watering: " + watering,"Soil: " + soil,"Temperature: " + temperature,"Humidity: " + humidity);
...
//        System.out.println(name2);
    ...
    public  void loader (Document query,ActionEvent event) throws IOException {
        FXMLLoader welcomeLoader = new FXMLLoader(getClass().getResource("DetailsShowNext.fxml"));
...
//        System.out.println(name2);
    ...
    @FXML
    public  void loader2 (Document query,ActionEvent event) throws IOException {
        FXMLLoader welcomeLoader = new FXMLLoader(getClass().getResource("DetailsShowNext.fxml"));
        Parent welcomeRoot = welcomeLoader.load();
        //Document query = new Document("name", name);
        DetailsShow detailsControl = welcomeLoader.getController();
